...
//ListViewQua
    ...
    private void initialize() {   
        ...
        TreeItem<String> webItem = new TreeItem<String>("Almacenamiento");
 		webItem.getChildren().add(new TreeItem<String>("Discoduro SSD"));
 		webItem.getChildren().add(new TreeItem<String>("Memoria RAM"));
        ...
        System.out.println(tree1.getExpandedItemCount());
    }
